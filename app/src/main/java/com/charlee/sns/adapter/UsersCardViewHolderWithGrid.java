 ...
 * 卡片ViewHolder
 */
public class UsersCardViewHolderWithGrid extends RecyclerView.ViewHolder {
    ...
    public UsersCardViewHolderWithGrid(@NonNull final View container) {
        super(container);
        this.container = container;
        cardView = (RecommendUsersCardView) container.findViewById(R.id.recommend_users);
        container.setVisibility(View.GONE);

        container.findViewById(R.id.layout_more).setOnClickListener(new View.OnClickListener() {
            @Override
