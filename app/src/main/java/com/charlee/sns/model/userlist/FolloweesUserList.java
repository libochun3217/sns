...
/**
 */
public class FolloweesUserList extends PageableList<SnsUser, UserInfo> {
    private final SnsUser snsUser;

    public FolloweesUserList(@NonNull final IMotuSns motuSns, @NonNull final IModelRepository repository,
