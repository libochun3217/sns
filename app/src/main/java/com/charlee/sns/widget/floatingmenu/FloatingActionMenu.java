 ...
 */
package com.charlee.sns.widget.floatingmenu;
...
import com.charlee.sns.widget.floatingmenu.animation.DefaultAnimationHandler;
import com.charlee.sns.widget.floatingmenu.animation.MenuAnimationHandler;
 ...
 * 注意：增加了在View内部指定子按钮容器的功能，见Build.setOverlayContainerInChildView。
 *       这个函数是相对在DecorView中添加子控件的做法，增加了在指定容器中添加子控件的方法
 */
...
public class FloatingActionMenu {
    ...
    private View mainActionViewForeground;
    /**
    ...
    private FrameLayout overlayContainerInChildView;
    ...
    public FloatingActionMenu(final View mainActionView,
                              final View mainActionViewForeground,
                              int startAngle,
                              int endAngle,
                              int radius,
                              ...
                              final boolean systemOverlay, FrameLayout overlayContainerInChildView) {
        this.mainActionView = mainActionView;
        this.mainActionViewForeground = mainActionViewForeground;
        ...
        this.overlayContainerInChildView = overlayContainerInChildView;
        ...
        if (systemOverlay) {
            orientationListener = new OrientationEventListener(mainActionView.getContext(), SensorManager
                    .SENSOR_DELAY_UI) {
        ...
        if (animated && animationHandler != null) {
            ...
            for (int i = 0; i < subActionItems.size(); i++) {
                ...
                if (systemOverlay) {
                    ...
                    params.setMargins(center.x - subActionItems.get(i).width / 2, center.y - subActionItems.get(i)
                            .height / 2, 0, 0);
                }
            ...
            for (int i = 0; i < subActionItems.size(); i++) {
                ...
                final FrameLayout.LayoutParams params = new FrameLayout.LayoutParams(subActionItems.get(i).width,
                        subActionItems.get(i).height, Gravity.TOP | Gravity.LEFT);
                if (systemOverlay) {
                    params.setMargins(subActionItems.get(i).x - overlayParams.x, subActionItems.get(i).y -
                            overlayParams.y, 0, 0);
    ...
    private Point getActionViewCoordinates() {
        ...
        if (systemOverlay) {
            ...
            if (overlayContainerInChildView == null) {
                ...
                coords[0] = mainActionView.getLeft();
                coords[1] = mainActionView.getTop();
            }
        }
    ...
    public View getMainActionMenuView() {
        return mainActionView;
    }

    public View getMainActionMenuViewForeground() {
        return mainActionViewForeground;
    }
    ...
    public View getActivityContentView() {
        try {
            return ((Activity) mainActionView.getContext()).getWindow().getDecorView().findViewById(android.R.id
                    .content);
            ...
            try {
                if (layoutParams != null) {
                    ...
                    if (overlayContainerInChildView == null) {
                        ...
                        overlayContainerInChildView.addView(view, lp);
                    }
                } else {
                    if (overlayContainerInChildView == null) {
                        ((ViewGroup) getActivityContentView()).addView(view);
                    } else {
                        overlayContainerInChildView.addView(view);
                    }
                }
            } catch (ClassCastException e) {
    ...
    public int getStatusBarHeight() {
        int result = 0;
        int resourceId = mainActionView.getContext().getResources().getIdentifier("status_bar_height", "dimen",
                "android");
        if (resourceId > 0) {
    ...
    public void removeViewFromCurrentContainer(View view) {
        if (systemOverlay) {
            ...
            if (overlayContainerInChildView == null) {
                ...
                overlayContainerInChildView.removeView(view);
            }
        }
    }
    ...
    public static class Builder {
        ...
        private View actionViewForground;
        private List<Item> subActionItems;
        private MenuAnimationHandler animationHandler;
        private boolean animated;
        private MenuStateChangeListener stateChangeListener;
        ...
        public Builder setOverlayContainerInChildView(FrameLayout overlayContainerInChildView) {
            this.overlayContainerInChildView = overlayContainerInChildView;
            return this;
        }
         ...
         * @return the builder object itself
         */
        public Builder attachTo(View actionView, View actionViewForground) {
            this.actionView = actionView;
            this.actionViewForground = actionViewForground;
            return this;
        }
