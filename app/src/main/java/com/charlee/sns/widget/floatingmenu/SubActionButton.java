...
public class SubActionButton extends FrameLayout {
    ...
    public SubActionButton(Context context, LayoutParams layoutParams, int theme, Drawable backgroundDrawable, View
        ...
        if (backgroundDrawable == null) {
            throw new RuntimeException("not set SubActionButton background");
        } else {
