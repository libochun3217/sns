...
public class SwipyRefreshLayout extends ViewGroup {
    ...
    private static final int ANIMATE_AUTO_LOADING = 1000;
...
//    }
    ...
    public SwipyRefreshLayout(Context context, AttributeSet attrs) {
        ...
        SwipyRefreshLayoutDirection direction
                = SwipyRefreshLayoutDirection.getFromInt(a2.getInt(R.styleable.SwipyRefreshLayout_swipe_direction, 0));
